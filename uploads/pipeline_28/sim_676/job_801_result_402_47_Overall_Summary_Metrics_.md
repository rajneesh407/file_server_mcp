    ...
    <p class="metric-name">Template Adherence Accuracy (NLP/ML Algorithms)</p>
    <div class="target-line">
        <p class="target-info">Target: >= 90% (cosine similarity)</p>
    ...
    <div class="target-line">
        <p class="target-info">Target: >= 90% (scores 4-5)</p>
        <div class="status-icon">
            ✅
        </div>
    </div>
