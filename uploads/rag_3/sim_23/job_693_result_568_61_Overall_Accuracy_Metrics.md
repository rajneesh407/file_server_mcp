    ...
    <body>
      <div class="metrics-container">
        ...
        <p class="subtitle" style="color: #EA4335;">Below target ≥90% on at least one metric (Avoid DB: 64.4%, Retrieval: 1.1%).</p>
        <div class="cards-grid">
          <!-- Left card: Avoid DB call accuracy -->
          <div class="metric-card metric-avoid-db">
            <div class="value-line">
              <span class="main-value">64.4%</span>
              <span class="range-tag">Range: (51.4% - 77.8%)</span>
            </div>
            <p class="metric-name">Accuracy of avoiding database call</p>
            <p class="aux-line">47/73 rows</p>
          ...
          <div class="metric-card metric-retrieval">
            <div class="value-line">
              <span class="main-value">1.1%</span>
              <span class="range-tag">Range: (0.7% - 1.4%)</span>
            </div>
            <p class="metric-name">Accuracy of card retrieval</p>
            <p class="aux-line">8/746 rows</p>
            <div class="target-line">
              <p class="target-info">Target: ≥90%</p>
              <div class="status-icon">❌</div>
            </div>
