    ...
    <body>
      <div class="metrics-container">
        ...
        <p class="subtitle" style="color: #EA4335;">Below target ≥90% on at least one metric (Avoid DB: 18.7%, Retrieval: 88.0%).</p>
        <div class="cards-grid">
          <!-- Left card: Avoid DB call accuracy -->
          <div class="metric-card metric-avoid-db">
            <div class="value-line">
              <span class="main-value">18.7%</span>
              <span class="range-tag">Range: (0.0% - 56.7%)</span>
            </div>
            <p class="metric-name">Accuracy of avoiding database call</p>
            <p class="aux-line">28/150 rows</p>
          ...
          <div class="metric-card metric-retrieval">
            <div class="value-line">
              <span class="main-value">88.0%</span>
              <span class="range-tag">Range: (70.0% - 96.7%)</span>
            </div>
            <p class="metric-name">Accuracy of card retrieval</p>
            <p class="aux-line">132/150 rows</p>
            <div class="target-line">
              <p class="target-info">Target: ≥90%</p>
